...
/** How much one song has been listened to. One row per song, capped (see user/plays.ts). */
export interface PlayStat {
  readonly songId: string;
  readonly plays: number;
  /** Seconds listened, all time. */
  readonly seconds: number;
  /** Seconds listened, halving every week as of `lastPlayedAt`: what they are into right now. */
